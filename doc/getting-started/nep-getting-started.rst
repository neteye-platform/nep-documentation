...
-------------------------------
To install NEP from from |witit|'s RPM Repository ``neteye-contrib``, just use Yum to install ``neteye-nep`` RPM inside your NetEye Server:
...
Install NEP from RPM Repository
-------------------------------
To install NEP from from |witit|'s RPM Repository ``neteye-contrib``, just use DNF to install neteye-nep RPM *on all Operative Cluster Nodes*:
