...
Installing NetEye Extension Packs from |witit|'s RPM Repository is fairly simple: just install the NEP RPM provided by the repository on the required NetEye Systems:
